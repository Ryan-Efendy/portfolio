    ...
    <Container>
      ...
      <Grid centered textAlign="center" verticalAlign="middle">
        <Grid.Column computer={4} mobile={16} tablet={4}>
          <Card
            href="https://github.com/Ryan-Efendy/reactnd-project-myreads"
            target="_blank"
          >
            <Image
        ...
        <Grid.Column computer={4} mobile={16} tablet={4}>
          <Card href="https://github.com/Ryan-Efendy/Readable" target="_blank">
            <Image
        ...
        <Grid.Column computer={4} mobile={16} tablet={4}>
          <Card
            href="https://github.com/Ryan-Efendy/Reduxstagram"
            target="_blank"
          >
            <Image
        ...
        <Grid.Column computer={4} mobile={16} tablet={4}>
          <Card href="https://github.com/Ryan-Efendy/Swipeify" target="_blank">
            <Image
